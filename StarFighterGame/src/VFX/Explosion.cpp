...
namespace st
{
    Explosion::Explosion(int particleAmt, float lifeTimeMin, float lifeTimeMax, float sizeMin, float sizeMax, float speedMin, float speedMax, sf::Color particleColor, const List<std::string>& particleImagePaths)
